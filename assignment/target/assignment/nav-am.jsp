	...
	<div class="container-fluid vh-100 pr-0">
		<div class="row w-100">
			...
			<div class="col vh-100 pl-lg-5 pr-0">
				<h1 class="title-regular mb-1 mt-5">Account management</h1>
				...
				<div class="text-white p-4 navigate-item mb-2" data-toggle="modal" data-target="#update_password">
					<h3 class="title-regular animate">update password</h3>
				...
				<%@ include file="template/modal/update_password.jsp"%>

				<% if (((String) session.getAttribute("role")).equalsIgnoreCase("admin")) { %>
					<a class="hyperlink" href="create_user.jsp">
						<div class="text-white p-4 navigate-item mb-2">
							<h3 class="title-regular animate">Create user</h3>
							<div class="my-2" style="width: 4rem; border: 3px solid #efefef;"></div>
							<p class="desc">
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corporis delectus maiores facere soluta necessitatibus, nobis excepturi saepe, eveniet quis error cumque placeat. Quae quos repellendus repudiandae optio ut reprehenderit minima.
							</p>
					...
					<a href="view_users.jsp?filter=student">
						<div class="text-white p-4 navigate-item mb-2">
							<h3 class="title-regular animate">Register student to course</h3>
							<div class="my-2" style="width: 4rem; border: 3px solid #efefef;"></div>
							<p class="desc">
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corporis delectus maiores facere soluta necessitatibus, nobis excepturi saepe, eveniet quis error cumque placeat. Quae quos repellendus repudiandae optio ut reprehenderit minima.
							</p>
					...
					<a class="hyperlink" href="view_users.jsp">
						<div class="text-white p-4 navigate-item mb-2">
							<h3 class="title-regular animate">View users / edit user role</h3>
							<div class="my-2" style="width: 4rem; border: 3px solid #efefef;"></div>
							<p class="desc">
								Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corporis delectus maiores facere soluta necessitatibus, nobis excepturi saepe, eveniet quis error cumque placeat. Quae quos repellendus repudiandae optio ut reprehenderit minima.
							</p>
